...
#                self.containerStack[-1]['container'].add(scrollPane)
    ...
    #def setGridFont(self, newFont):
    #    self.gridFont = font.Font(family="Times", size=newFont)
...
class SimpleGrid(ScrollPane):
    ...
    def configure(self, cnf=None, **kw):
        ...
        if "font" in kw:
            ...
            self.buttonFont.configure(family=font.actual("family"), size=font.actual("size"))
        if "buttonFont" in kw:
            #print("Yes!")
            #print(kw)
    ...
    def setGrid(self, newData, scroll=True):
        self.__hideEntryBoxes()
        self.__setGrid(newData)
